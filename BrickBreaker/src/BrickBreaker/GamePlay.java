...
public class GamePlay extends JPanel implements KeyListener,ActionListener{
    ...
    private int totalBricks;
      ...
      private final int maxHeight = 494;
      private final int minHeight= 375;
      ...
      private MapGenerator map;
        ...
        private void reset(boolean win){
          ...
          playerX = 310;
          rand = new Random(); 
          ballposX = rand.nextInt(maxWidth-minWidth) + minWidth;
          ballposY = rand.nextInt(maxHeight-minHeight) + minHeight;
            ...
            A:for(int i = 0;i< map.map.length;i++){
                for(int j = 0; j<map.columns;j++){
                    if(map.map[i][j]>0){
                        ...
                        //System.out.println("brickX: "+brickX);
                        ...
                        if(ballRect.intersects(brickRect)){
                            int brickHealth = map.getBrickValue(i,j);
                            map.setBrickValue(--brickHealth, i, j);
                            if(brickHealth <= 0){
                                totalBricks --;
                            }
